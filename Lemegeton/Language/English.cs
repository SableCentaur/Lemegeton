namespace Lemegeton.Language
{
    ...
    internal class English : Core.Language
    {
        ...
        public English()
        {
            ...
            AddEntry("Content/EndwalkerTrials", "Endwalker (6.x)");
            AddEntry("Content/EndwalkerTrials/Enabled", "Enabled");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante", "Rubicante EX");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante/Enabled", "Enabled");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante/FlamespireAM", "Flamespire Automarker");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante/FlamespireAM/Enabled", "Enabled");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante/FlamespireAM/SelfMarkOnly", "Self-marking only");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante/FlamespireAM/AsSoftmarker", "Show as client-side soft markers");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante/FlamespireAM/Signs", "Marker configuration");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante/FlamespireAM/Signs/ShareTarget", "Furious Welt (Stack1)");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante/FlamespireAM/Signs/Share1", "Blooming Welt (Stack 2)");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante/FlamespireAM/Signs/Share2", "Blooming Welt (Stack 3)");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante/FlamespireAM/Signs/Share3", "Blooming Welt (Stack 4)");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante/FlamespireAM/Signs/Spread1", "Stinging Welt (Spread 1)");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante/FlamespireAM/Signs/Spread2", "Stinging Welt (Spread 2)");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante/FlamespireAM/Signs/Spread3", "Stinging Welt (Spread 3)");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante/FlamespireAM/Signs/Spread4", "Stinging Welt (Spread 4)");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante/FlamespireAM/Prio", "Priority configuration");
            AddEntry("Content/EndwalkerTrials/EwTrialsRubicante/FlamespireAM/Test", "Test assignment (respecting priority)");
